...
<script>
import ProgressList from './ProgressList/Index-view.vue'
import TopHeroes from './TopHeroes/Index-view.vue'
import HeroesList from './HeroesList/Index-view.vue'
import PlayerStats from './PlayerStats/Index-view.vue'
