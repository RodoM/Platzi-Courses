...
import HeroAttributes from './HeroAttributes/Index-view.vue'
import HeroItems from './HeroItems/Index-view.vue'
import HeroSkills from './HeroSkills/Index-view.vue'

export default {
  name: 'HeroView',
  mixins: [setError],
  components: { BaseLoading, HeroDetailHeader, HeroAttributes, HeroItems, HeroSkills },
  data () {
    return {
      isLoading: false,
      hero: null,
